...
export default {
    data() {
        return {
            ...
            QRValue: `https://localhost:5173/product/${this.$route.params.id}`,
        }
    },
    computed: {
        ...mapState(useProductStore, ['productsWithId'])
    },
    methods: {
        ...mapActions(useProductStore, ['fetchProductDetail', 'addMyFavorite']),

        handleAddFavorite() {
            this.addMyFavorite(this.id);
        }
    },
    created() {
            ...
            <div class="container px-5 py-24 mx-auto">
                <div class="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded"
                        :src="productsWithId.imgUrl">
                    <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        <h2 class="text-sm title-font text-gray-500 tracking-widest">{{ productsWithId.category }}</h2>
                        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{{ productsWithId.name }}</h1>
                        <div class="flex mb-4">
                        ...
                        <p class="leading-relaxed">{{ productsWithId.description }}</p>
                        ...
                        <div class="flex">
                            <span class="title-font font-medium text-2xl text-gray-900">Rp. {{
                                productsWithId.price.toLocaleString("id-ID") }}</span>
                            <button @click.prevent="handleAddFavorite"
                        ...
                        <!-- QR code -->
                        <div>
                            <p>or you can scan this barcode to see the product's detail</p><br>
